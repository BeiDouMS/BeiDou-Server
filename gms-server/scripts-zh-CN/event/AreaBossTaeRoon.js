...
// 地图 ID (BOSS 生成的地图)
const MapID = 250010304;

// BOSS ID (要生成的怪物 ID)
const BossID = 7220000;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 700) - 800), 390);

// BOSS 出现时的全服公告内容
const BossNotice = "伴着一声柔和的哨音翩然而至‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossTaeRoon";
