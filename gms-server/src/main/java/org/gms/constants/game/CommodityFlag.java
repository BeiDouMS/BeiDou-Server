...
public enum CommodityFlag {
    ...
    MAPLE_POINT(1 << 6, 10, "抵用券", (p, n)-> p.writeInt(n.intValue())),
    MESO(1 << 7, 11, "金币", (p, n)-> p.writeInt(n.intValue())),
    FOR_PREMIUM_USER(1 << 8, 12, "高级用户", (p, n)-> p.writeInt(n.intValue() - 1)),
    COMMODITY_GENDER(1 << 9, 13, "性别", (p, n)-> p.writeByte(n.intValue())),
    ON_SALE(1 << 10, 14, "是否销售", (p, n)-> p.writeByte(n.intValue())),
