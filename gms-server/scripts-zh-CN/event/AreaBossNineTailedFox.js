...
// 地图 ID (BOSS 生成的地图)
const MapID = 222010310;

// BOSS ID (要生成的怪物 ID)
const BossID = 7220001;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 1300) - 800), 33);

// BOSS 出现时的全服公告内容
const BossNotice = "伴随着一声悠长的狐啸划破夜色，那老狐的气息如雾霭般在林间弥散‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossNineTailedFox";
