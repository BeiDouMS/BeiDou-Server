...
// 地图 ID (BOSS 生成的地图)
const MapID = 200010300;

// BOSS ID (要生成的怪物 ID)
const BossID = 8220000;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(208, 83);

// BOSS 出现时的全服公告内容
const BossNotice = "降临之时，黑色旋风如巨蟒盘绕，将天光绞碎成纷扬的鸦羽‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossEliza1";
