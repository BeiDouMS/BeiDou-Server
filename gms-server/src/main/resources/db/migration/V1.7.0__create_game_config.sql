...
values ('world', '0', 'java.lang.Integer', 'flag', '0', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'allow_steal_quest_item', 'false', '是否允许神通术技能应用于任务类型的道具(It is allowed for the Steal skill to be applied to quest-type items.)'),
