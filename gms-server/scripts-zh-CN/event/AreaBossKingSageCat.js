...
// 地图 ID (BOSS 生成的地图)
const MapID = 250010504;

// BOSS ID (要生成的怪物 ID)
const BossID = 7220002;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 1300) - 500), 540);

// BOSS 出现时的全服公告内容
const BossNotice = "的出现使幽魅之气愈发浓稠，野猫的泣鸣如锈蚀的刀片划破凝滞的夜雾‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossKingSageCat";
