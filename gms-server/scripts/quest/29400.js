...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            qm.sendNext("Hunt #r100000#k monsters that are higher level than you within 30 days! Anyone who completes this task will receive the title, #e#bVeteran Hunter#k#n. The person with the highest score will receive the #e#bLegendary Hunter (Special Title)#k#n.");
        } else if (status == 1) {
