...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendOk("事情是这样的：扭曲大师，也就是目前控制绯红要塞的重要人物，正计划对射手村发动一次大规模袭击，可能就在接下来的几天内发生。我不能只是站在这里看着他们准备这次袭击，但我也不能离开这个位置，必须不惜一切代价留意他们的动向。这就是你的任务：去找卢坎，那位过去绯红要塞的骑士。他现在正在森林中徘徊，从他那里接受进一步的指示，他知道该怎么做。");
        qm.forceStartQuest();
    } else if (status == 2) {
        qm.dispose();
    }
