...
// 地图 ID (BOSS 生成的地图)
const MapID = 100040105;

// BOSS ID (要生成的怪物 ID)
const BossID = 5220002;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(456, 278);

// BOSS 出现时的全服公告内容
const BossNotice = "自靛蓝雾霭中显形时，整片天空呈现出光谱折射的奇异蓝调，仿佛歌德手稿里未完成的魔法阵正在现世具象化‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossFaust1";
