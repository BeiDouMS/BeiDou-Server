...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (sel == 0) {
            ...
            cm.sendNext("你什么时候可以选择你的职业？哈哈哈，放轻松，我的朋友。每个职业都有一定的要求需要你达到。通常8级到10级之间就可以了，所以努力吧。");
        } else if (sel == 5) {
            cm.sendNext("想了解这个岛吗？它叫做彩虹岛，漂浮在空中。它已经漂浮在天空一段时间了，所以强大的怪物并不常见。这是一个非常宁静的岛屿，非常适合初学者！");
        } else if (sel == 6) {
            cm.sendNext("你想成为一名#b战士#k吗？嗯，那么我建议你前往金银岛。前往一个名叫#r勇士部落#k的战士城镇，找#b与巴尔洛克共舞#k。他会教你如何成为一名真正的战士。哦，还有一件非常重要的事情：你至少需要达到10级才能成为一名战士！！");
        } else if (sel == 7) {
            cm.sendNext("你想成为一名#b弓箭手#k吗？你需要前往金银岛进行职业转职。前往一个名为#r射手村#k的弓箭手之镇，与美丽的#b雅典娜·皮尔斯#k交谈，学习成为一名弓箭手的各种技巧。哦，还有一件非常重要的事情：你需要至少达到10级才能成为一名弓箭手！");
        } else if (sel == 8) {
            cm.sendNext("你想成为一个#b魔法师#k吗？为了做到这一点，你需要前往金银岛。前往一个名为#r魔法密林#k的魔法师森林，顶部就是魔法图书馆。在里面，你会遇到所有法师的头领#b古老的格伦德#k，他会教你成为一名法师的一切。");
        } else if (sel == 9) {
            cm.sendNext("你想成为一个#b盗贼#k吗？为了成为一个盗贼，你需要前往金银岛。前往一个名为#r废弃都市#k的盗贼城镇，在城镇的阴暗一侧，你会看到一个盗贼的藏身之处。在那里，你会遇到#b黑暗领主#k，他会教你关于成为盗贼的一切。哦，还有一件非常重要的事情：你需要至少达到10级才能成为一个盗贼！！");
        } else if (sel == 10) {
