...
// 地图 ID (BOSS 生成的地图)
const MapID = 230020100;

// BOSS ID (要生成的怪物 ID)
const BossID = 4220001;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 2300) - 1500), 520);

// BOSS 出现时的全服公告内容
const BossNotice = "，一枚泛着诡异磷光的贝壳悄然浮现在幽暗的海藻林中，其螺旋纹路在流动的藻须间若隐若现‌";
