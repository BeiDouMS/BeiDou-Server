...
function start(mode, type, selection)
{
	if (CheckStatus(mode))
	{
		...
		{
			//最后一层对话完继续循环至此，退出结束
			qm.sendAcceptDecline("记住，冒险岛不只是冒险，它是一场对常规的无情嘲弄，是对逻辑的彻底颠覆！所以，请放开您的笑点，拥抱这份疯狂，与我们一起，在荒诞与奇幻中，创造属于我们的神经质传奇吧！哈哈，让我们一起，笑对人生，疯癫到底！");
		}
		else if (status == 3)
		{
			...
			qm.sendOk("好的，请跟你面前的昨日酣睡对话吧！祝您游戏开心。");
			qm.forceStartQuest();
            qm.dispose();
		}
		else
