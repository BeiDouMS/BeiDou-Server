...
// 地图 ID (BOSS 生成的地图)
const MapID = 677000007;

// BOSS ID (要生成的怪物 ID)
const BossID = 9400611;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 100) + 100), 50);

// BOSS 出现时的全服公告内容
const BossNotice = "克罗塞尔降临之际，硫磺火雨在它蝠翼的阴影中凝成悬浮的赤红结晶，方圆十里的电子设备同时爆出幽蓝电弧‌";
