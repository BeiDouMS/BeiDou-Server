        ...
        if (cm.getPlayer().getMapId() == 980000010) {
            ...
            if (status == 0) {
                ...
                if (select == 0) {
                    ...
                    status = 10;
                    cm.sendSimple("请确保您拥有 # t4001129 # 用于您想要的武器。选择您想要交易的武器 # t4001129 #。我有的选择都非常好，而且我不是那些说话的人！\r\n#b#L0# #z1302004#（" + n3 + " 金币）#l\r\n#L1# #z1402006#（" + n3 + " 金币）#l\r\n#L2# #z1302009#（" + n4 + " 金币）#l\r\n#L3# #z1402007#（" + n4 + " 金币）#l\r\n#L4# #z1302010#（" + n5 + " 金币）#l\r\n#L5# #z1402003#（" + n5 + " 金币）#l\r\n#L6# #z1312006#（" + n3 + " 金币）#l\r\n#L7# #z1412004#（" + n3 + " 金币）#l\r\n#L8# #z1312007#（" + n4 + " 金币）#l\r\n#L9# #z1412005#（" + n4 + " 金币）#l\r\n#L10# #z1312008#（" + n5 + " 金币）#l\r\n#L11# #z1412003#（" + n5 + " 金币）#l\r\n#L12# 继续到下一页（1/2）#l");
                } else if (select == 3) {
                    status = 20;
                    cm.sendSimple("选择您想要交易的武器。我这里的武器非常吸引人。亲自看看吧！\r\n#b#L0# #z1372001#（" + n3 + " 金币）#l\r\n#L1# #z1382018#（" + n3 + " 金币）#l\r\n#L2# #z1372012#（" + n4 + " 金币）#l\r\n#L3# #z1382019#（" + n4 + " 金币）#l\r\n#L4# #z1382001#（" + n5 + " 金币）#l\r\n#L5# #z1372007#（" + n5 + " 金币）#l");
                } else if (select == 4) {
                    status = 30;
                    cm.sendSimple("选择您想要交易的武器。我这里的武器非常吸引人。亲自看看吧！\r\n#b#L0# #z1452006#（" + n3 + " 金币）#l\r\n#L1# #z1452007#（" + n4 + " 金币）#l\r\n#L2# #z1452008#（" + n5 + " 金币）#l\r\n#L3# #z1462005#（" + n3 + " 金币）#l\r\n#L4# #z1462006#（" + n4 + " 金币）#l\r\n#L5# #z1462007#（" + n5 + " 金币）#l");
                } else if (select == 5) {
                    status = 40;
                    cm.sendSimple("选择您想要交易的武器。我所拥有的武器质量最高。选择对您最有吸引力的那一件！\r\n#b#L0# #z1472013#（" + n3 + " 金币）#l\r\n#L1# #z1472017#（" + n4 + " 金币）#l\r\n#L2# #z1472021#（" + n5 + " 金币）#l\r\n#L3# #z1332014#（" + n3 + " 金币）#l\r\n#L4# #z1332031#（" + n4 + " 金币）#l\r\n#L5# #z1332011#（" + n4 + " 金币）#l\r\n#L6# #z1332016#（" + n5 + " 金币）#l\r\n#L7# #z1332003#（" + n5 + " 金币）#l");
                } else if (select == 6) {
                    status = 50; //pirate rewards
                    cm.sendSimple("选择您想要交易的武器。我所拥有的武器质量最高。选择对您最有吸引力的那一件！\r\n#b#L0# #z1482005#（" + n3 + " 金币）#l \r\n#b#L1# #z1482006#（" + n4 + " 金币）#l \r\n#b#L2# #z1482007#（" + n5 + " 金币）#l \r\n#b#L3# #z1492005#（" + n3 + " 金币）#l \r\n#b#L4# #z1492006#（" + n4 + " 金币）#l \r\n#b#L5# #z1492007#（" + n5 + " 金币）#l");
                }
            } else if (status == 11) {
                if (selection == 12) {
                    cm.sendSimple("选择您想要交易的武器。我这里的武器非常有用。看一看！\r\n#b#L0# #z1322015#（" + n3 + " 金币）#l\r\n#L1# #z1422008#（" + n3 + " 金币）#l\r\n#L2# #z1322016#（" + n4 + " 金币）#l\r\n#L3# #z1422007#（" + n4 + " 金币）#l\r\n#L4# #z1322017#（" + n5 + " 金币）#l\r\n#L5# #z1422005#（" + n5 + " 金币）#l\r\n#L6# #z1432003#（" + n3 + " 金币）#l\r\n#L7# #z1442003#（" + n3 + " 金币）#l\r\n#L8# #z1432005#（" + n4 + " 金币）#l\r\n#L9# #z1442009#（" + n4 + " 金币）#l\r\n#L10# #z1442005#（" + n5 + " 金币）#l\r\n#L11# #z1432004#（" + n5 + " 金币）#l\r\n#L12# 返回第一页（2/2）#l");
                } else {
                ...
                if (allDone) {
                    ...
                    cm.sendOk("完成。请注意，一些物品无法合成，可能是因为您的杂项物品栏空间不足，或者没有足够的金币来支付费用。");
                }
                cm.dispose();
            }
        }
