...
var stage1Questions = Array(
    ...
    "收集与#b战士#n首次转职所需最低力量（STR）相同数量的#b证书#n。",
    "收集与#b魔法师#n首次转职所需最低智力（INT）相同数量的#b证书#n。",
    "收集与#b弓箭手#n首次转职所需最低敏捷（DEX）相同数量的#b证书#n。",
    "收集与#b飞侠#n首次转职所需最低敏捷（DEX）相同数量的#b证书#n。",
