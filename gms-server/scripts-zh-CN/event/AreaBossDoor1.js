...
// 地图 ID (BOSS 生成的地图)
const MapID = 677000003;

// BOSS ID (要生成的怪物 ID)
const BossID = 9400610;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 100) + 400), 0);

// BOSS 出现时的全服公告内容
const BossNotice = "安度西亚斯‌撕裂天幕降临，其独角兽形躯体由失传的《格里高利圣咏》手稿羊皮纸折叠而成，每根毛发都是凝固的管风琴音管‌";
