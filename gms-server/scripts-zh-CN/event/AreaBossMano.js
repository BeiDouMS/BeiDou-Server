 ...
 *
 *  使用说明：
 *  - 复制此文件为新档案 (例如 AreaBossMuseroom.js)。
 *  - 修改 [配置区域] 内的参数即可。
 */
...
// 地图 ID (BOSS 生成的地图)
const MapID = 104000400;

// BOSS ID (要生成的怪物 ID)
const BossID = 2220000;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(279, -496);

// BOSS 出现时的全服公告内容
const BossNotice = "瑪諾的身影伴隨著涼風乍起時悄然顯現，落叶在她脚边打着旋儿静止";
