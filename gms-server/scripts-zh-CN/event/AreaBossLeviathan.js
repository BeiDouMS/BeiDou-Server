...
// 地图 ID (BOSS 生成的地图)
const MapID = 240040401;

// BOSS ID (要生成的怪物 ID)
const BossID = 8220003;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 600) - 300), 1125);

// BOSS 出现时的全服公告内容
const BossNotice = "昂首而起的刹那，裹挟着冰晶的寒风如远古战吼般撕裂云层‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossLeviathan";
