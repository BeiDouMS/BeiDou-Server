...
// 地图 ID (BOSS 生成的地图)
const MapID = 110040000;

// BOSS ID (要生成的怪物 ID)
const BossID = 5220001;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 2400) - 1600), 140);

// BOSS 出现时的全服公告内容
const BossNotice = "出现在海岸线上，一顶形似螺壳的奇异头巾随潮水起伏，其螺旋纹路在夕照下泛着妖异的磷光‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossKingClang";
