...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (sel == 0) {
            ...
            cm.sendNext("你什么时候可以选择你的职业？哈哈哈，放轻松，我的朋友。每个职业都有一定的要求需要你达到。通常8级到10级之间就可以了，所以努力工作吧。");
        } else if (sel == 5) {
            cm.sendNext("想了解这个岛吗？它叫做枫之岛，漂浮在空中。它已经漂浮在天空一段时间了，所以恶毒的怪物并不常见。这是一个非常宁静的岛屿，非常适合初学者！");
        } else if (sel == 6) {
            cm.sendNext("你想成为一名#b战士#k吗？嗯，那么我建议你前往维多利亚岛。前往一个名叫#r佩里安#k的战士城镇，找#b与巴尔洛克共舞#k。他会教你如何成为一名真正的战士。哦，还有一件非常重要的事情：你至少需要达到10级才能成为一名战士！！");
        } else if (sel == 7) {
            cm.sendNext("你想成为一名#b弓箭手#k吗？你需要前往维多利亚岛进行职业转职。前往一个名为#r亨尼西斯#k的弓箭手之镇，与美丽的#b雅典娜·皮尔斯#k交谈，学习成为一名弓箭手的各种技巧。哦，还有一件非常重要的事情：你需要至少达到10级才能成为一名弓箭手！");
        } else if (sel == 8) {
            cm.sendNext("你想成为一个#b魔法师#k吗？为了做到这一点，你需要前往维多利亚岛。前往一个名为#r艾利尼亚#k的魔法师之城，顶部就是魔法图书馆。在里面，你会遇到所有巫师的头领#b古老的格伦德#k，他会教你成为一名巫师的一切。");
        } else if (sel == 9) {
            cm.sendNext("你想成为一个#b盗贼#k吗？为了成为一个盗贼，你需要前往维多利亚岛。前往一个名为#r废都市#k的盗贼城镇，在城镇的阴暗一侧，你会看到一个盗贼的藏身之处。在那里，你会遇到#b黑暗领主#k，他会教你关于成为盗贼的一切。哦，还有一件非常重要的事情：你需要至少达到10级才能成为一个盗贼！！");
        } else if (sel == 10) {
            ...
            cm.sendNext("你如何到达维多利亚岛？在这个岛的东部有一个叫做南港的港口。在那里，你会找到一艘在空中飞行的船。船前站着船长。问他关于这件事。");
        } else if (sel == 16) {
        ...
        if (sel == 0) {
            ...
            cm.sendNextPrev("但是，如果你想成为一个强大的玩家，最好不要考虑在这里呆太久。你也不会找到工作。这个岛屿下面有一个叫做维多利亚岛的巨大岛屿。那个地方比这里大得多，甚至有些荒谬。");
        } else if (sel == 8) {
