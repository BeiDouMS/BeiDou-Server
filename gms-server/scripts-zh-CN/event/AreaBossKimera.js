...
// 地图 ID (BOSS 生成的地图)
const MapID = 261030000;

// BOSS ID (要生成的怪物 ID)
const BossID = 8220002;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 900) - 900), 180);

// BOSS 出现时的全服公告内容
const BossNotice = "自地底幽暗中现身的刹那，眼瞳里跃动的碎光如未淬火的星屑‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossKimera";
