...
// 地图 ID (BOSS 生成的地图)
const MapID = 677000009;

// BOSS ID (要生成的怪物 ID)
const BossID = 9400613;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 100) + 300), -841);

// BOSS 出现时的全服公告内容
const BossNotice = "出现的瞬间，月光在它蛇鳞状的皮毛上折射出千重幻影，所有目睹者的视网膜上同时烙下旋转的倒五芒星‌";
