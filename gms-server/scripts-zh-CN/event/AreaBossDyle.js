...
// 地图 ID (BOSS 生成的地图)
const MapID = 107000300;

// BOSS ID (要生成的怪物 ID)
const BossID = 6220000;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(90, 119);

// BOSS 出现时的全服公告内容
const BossNotice = "破开沼泽浮出时，腐殖质的气味与沼气在它嶙峋的背甲上凝结成绿色雾霭‌";
