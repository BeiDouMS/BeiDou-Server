...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendOk("事情是这样的：扭曲大师，目前控制着绯红要塞的重要人物，计划对射手村发动一次大规模袭击，可能会在接下来的几天内发生。我不能就这样呆在这里观察，而他们准备这次袭击。但是，我不能就这样离开这个位置，我必须不惜一切代价留意他们的动向。这就是你的任务：去找到卢坎，过去绯红要塞的骑士，他目前正在树林中徘徊，从他那里接受进一步的指令，他知道该怎么做。");
        qm.forceStartQuest();
    } else if (status == 2) {
        qm.dispose();
    }
