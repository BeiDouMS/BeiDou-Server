    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendOk("#e#b<组队任务：维度裂隙>#k#n\r\n#b#m220000000#!#k出现了维度裂隙！我们迫切需要勇敢的冒险家来击败入侵的怪物。请和一些可靠的盟友组队，拯救#m220000000#! 你必须通过击败怪物和解决谜题来通过各个阶段，最终击败#r#o9300012##k。");
                cm.dispose();
            }
        }
    }
