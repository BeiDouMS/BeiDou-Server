...
// Spawn Point (X, Y)
const SpawnPoint = new java.awt.Point(posX, posY);

// Boss Announcement
const BossNotice = "The ghostly air around here has become stronger. The unpleasant sound of a cat crying can be heard.";
