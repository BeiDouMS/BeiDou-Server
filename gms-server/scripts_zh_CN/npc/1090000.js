...
function start() {
    ...
    if (cm.isQuestStarted(6330)) {
        ...
        if (cm.getJobId() == 0) {
            ...
            cm.sendNext("你来了。几天前，奥西里亚的#b#p2020013##k跟我谈到了你。我看到你对于成为海盗职业的第三次转职很感兴趣。为了实现这个目标，我需要测试一下你的实力，看看你是否配得上这个晋升。维多利亚岛上有一个洞穴中的开口，会通往一个秘密通道。一旦进入，你将面对我的分身。你的任务是打败他，并带着#b#t4031059##k回来。");
