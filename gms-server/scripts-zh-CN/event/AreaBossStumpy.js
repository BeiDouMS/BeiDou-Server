...
// 地图 ID (BOSS 生成的地图)
const MapID = 101030404;

// BOSS ID (要生成的怪物 ID)
const BossID = 3220000;
...
// BOSS 生成坐标 (X, Y)
const SpawnPoint = new java.awt.Point(Math.floor((Math.random() * 800) + 400), 1280);

// BOSS 出现时的全服公告内容
const BossNotice = "伴着沉闷的撞击声现身于石山之间，余音在山谷中回荡‌";
...
// 事件实例名称 (自动获取，无需修改)
const EventName = "AreaBossStumpy";
